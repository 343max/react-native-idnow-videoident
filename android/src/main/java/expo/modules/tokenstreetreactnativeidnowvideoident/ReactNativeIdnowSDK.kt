...
object ReactNativeIdnowSDK {
    ...
    fun initializeWithSettings(
        @NonNull currentActivity: Activity?,
        ...
        val instance: IDnowSDK = IDnowSDK.getInstance()
        instance.initialize(
            currentActivity,
    ...
    @Nullable
    private fun getEnvironment(@Nullable environment: String): IDnowSDK.Server {
        val environmentMap: HashMap<String, IDnowSDK.Server> = HashMap<String, IDnowSDK.Server>()
    ...
    @Nullable
    private fun getConnectionType(@Nullable connectionType: String): IDnowSDK.ConnectionType {
        val connectionTypeMap: HashMap<String, IDnowSDK.ConnectionType> =
            HashMap<String, IDnowSDK.ConnectionType>()
